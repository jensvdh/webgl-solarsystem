	...
	var time=1;
	var gui;
	var followableBodies=new Array();
	...
	if(!init())animate();
		...
		function initCelestialBodies()
		{
			...
			var earth=new CelestialBody("earth",1.3,"../../../images/textures//earth.jpg",50,true,500,0,0.16,0,25,sun.mesh);
			makePlanetFollowable(earth,1,5);
			var atmosphere=new CelestialBody("atmosphere",1.32,"../../../images/textures//clouds.png",50,true,500,0,0.30,0.03,25,sun.mesh);
			...
			var mercury=new CelestialBody("mercury",0.5,"../../../images/textures//mercury.jpg",30,true,12,0.001,0.2,0,25,sun.mesh);
			makePlanetFollowable(mercury,2,3);
			var venus=new CelestialBody("venus",1.2,"../../../images/textures//venus.jpg",34,true,31,0,0.02,0.05,25,sun.mesh);
			makePlanetFollowable(venus,5,5);
			var jupiter=new CelestialBody("jupiter",14,"../../../images/textures//jupiter.jpg",87,true,593,0,0.003,0,35,sun.mesh);
			makePlanetFollowable(jupiter,80,60);
			var saturn=new CelestialBody("saturn",12,"../../../images/textures//saturn.jpg",339,true,1473,0.002,0,0.005,25,sun.mesh);
			makePlanetFollowable(saturn,240,18);
			var mars=new CelestialBody("mars",0.7,"../../../images/textures//mars.jpg",43,true,94,0.02,0,0.05,25,sun.mesh);
			makePlanetFollowable(mars,3,3);
			var uranus=new CelestialBody("uranus",5,"../../../images/textures//uranus.jpg",455,true,4204,0,0.0002,0.0005,25,sun.mesh);
			makePlanetFollowable(uranus,350,15);
			var neptune=new CelestialBody("neptune",4.7,"../../../images/textures//neptune.jpg",700,true,8241,0.0003,0,0.0001,25,sun.mesh);
